############################################################################################
# BV_priors_Monte_Carlo_example.R
#
# Demonstration of a biological-variation (BV)–based PEB approach for
# personal reference intervals (prRI), using simulated nested BV data with known parameters.
############################################################################################
