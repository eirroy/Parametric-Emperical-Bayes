...
# PEB_apply_BV_priors
#
# Application of PEB approach using known Biological Variation (BV) priors.
##############################################################################
...
mu_pop <- 100        # population mean on the original scale
...
mu_pop    <- log(mu_pop)  # population mean on log scale
